...
public class MerchantCouponController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/merchant/searchCoupon", method = RequestMethod.POST)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/merchant/inquiryCoupon", method = RequestMethod.POST)
	@ResponseStatus(HttpStatus.CREATED)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/merchant/changeCoupon", method = RequestMethod.POST)
	@ResponseStatus(HttpStatus.CREATED)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/merchant/searchUserCoupon", method = RequestMethod.POST)
	@ResponseStatus(HttpStatus.CREATED)
	@ResponseBody
