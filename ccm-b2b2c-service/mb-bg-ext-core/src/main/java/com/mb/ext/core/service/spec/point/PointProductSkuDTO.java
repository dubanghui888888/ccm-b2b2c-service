...
public class PointProductSkuDTO extends AbstractBaseDTO{
...
//	private String productAttrUuids;
	...
	private List<PointProductSkuAttrValueDTO> skuAttrValueList = new ArrayList<PointProductSkuAttrValueDTO>();


	public List<PointProductSkuAttrValueDTO> getSkuAttrValueList() {
		return skuAttrValueList;
	}

	public void setSkuAttrValueList(List<PointProductSkuAttrValueDTO> skuAttrValueList) {
	...
	public BigDecimal getSkuUnitPrice() {
		return skuUnitPrice!=null?skuUnitPrice:BigDecimal.valueOf(0);
	}
	...
	public BigDecimal getSkuUnitPriceStandard() {
		return skuUnitPriceStandard!=null?skuUnitPriceStandard:BigDecimal.valueOf(0);
	}
