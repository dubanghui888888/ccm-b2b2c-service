...
public class AdminAfterSaleController {
	 ...
	 * @return 返回数据
	 */
	@RequestMapping(value = "/admin/approveOrderAfterSale", method = RequestMethod.POST)
	 ...
	 * @return 返回数据
	 */
	@RequestMapping(value = "/admin/rejectOrderAfterSale", method = RequestMethod.POST)
	@ResponseStatus(HttpStatus.CREATED)
	@ResponseBody
	 ...
	 * @return 返回数据
	 */
	@RequestMapping(value = "/admin/confirmOrderAfterSale", method = RequestMethod.POST)
	@ResponseStatus(HttpStatus.CREATED)
	@ResponseBody
	 ...
	 * @return 返回数据
	 */
	@RequestMapping(value = "/admin/searchOrderAfterSale", method = RequestMethod.POST)
	@ResponseStatus(HttpStatus.CREATED)
	@ResponseBody
	 ...
	 * @return 返回数据
	 */
	@RequestMapping(value = "/admin/inquiryOrderAfterSaleDetail", method = RequestMethod.POST)
	@ResponseStatus(HttpStatus.CREATED)
	@ResponseBody
